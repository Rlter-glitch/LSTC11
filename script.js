const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      "tuyển chọn những người giỏi chiến đấu làm tướng chỉ huy, không căn cứ vào quê quán như trước.",
      "thải hồi người già yếu, bổ sung người có nguồn gốc tôn thất.",
      "thải hồi người có nguồn gốc tôn thất, bổ sung người chiến đấu giỏi."
    ],
    correct: "A"
  },
  {
...
function shuffleArray(array) {
  const arr = array.slice(); // tạo bản sao
...
function loadQuiz() {
  ...
  questions.forEach((question, index) => {
    ...
    shuffledOptions.forEach((optionText, i) => {
      ...
      input.value = optionText; // giá trị là nội dung thực tế
    ...
    // Gắn thêm dữ liệu để chấm điểm
    questionDiv.dataset.correctAnswer = correctOptionText;
...
function submitQuiz() {
  ...
  questionsDivs.forEach((questionDiv) => {
    ...
    // Kiểm tra xem người dùng có chọn đáp án đúng không
